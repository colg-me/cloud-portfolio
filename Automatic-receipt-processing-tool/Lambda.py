...
SES_SENDER_EMAIL = os.environ.get('SES_SENDER_EMAIL', 'giuseppe.coluccii24@mail.com')
SES_RECIPIENT_EMAIL = os.environ.get('SES_RECIPIENT_EMAIL', 'giuseppe.coluccii24@mail.com')
